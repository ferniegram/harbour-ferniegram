...
signals:
    ...
    void chatNotificationSettingsUpdated(qlonglong chatId, const QVariantMap updatedChatNotificationSettings);
    ...
    void chatMembers(qlonglong extra, const QVariantList &members, int totalMembers);
    ...
    void userProfilePhotos(qlonglong extra, const QVariantList &photos, int totalPhotos);
